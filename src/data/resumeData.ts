...
export const resumeData = {
  ...
  about: {
    description: [
      ...
      '서비스의 가장 앞단에서 사용자와 마주하는 웹 프론트엔드 분야에 매력을 느껴 커리어를 시작한 이래, 현재는 기능 개발을 포함한 제품 생애주기의 전반에 관심을 갖고 개발을 하고 있습니다. 좋은 동료이자 신뢰할 수 있는 전문가로서, 사용자가 쓰기 편하면서도 기술적으로도 안정적이고 효율적인 제품을 만들고 싶습니다.',
    ],
  },
  experience: [
    {
